...
![alt text](</assets/img/sidi 1.jpg>)

{:width="250" style="float: right"}La historicidad del Poema 
...
![alt text](</assets/img/sidi 2.jpg>)
...
![alt text](</assets/img/sidi 3.jpg>)

{:width="200" style="float: left"} Los hechos que narra el 
...
![alt text](</assets/img/sidi 4.jpg>)

{:width="200" style="float: right"} El héroe Rodrigo Ruy 
...
![alt text](</assets/img/sidi 5.jpg>)

{:width="200" style="float: right"} El destierro del Cid por 
...
![alt text](</assets/img/sidi 6.jpg>)
...
![alt text](</assets/img/sidi 7.jpg>)

{:width="200" style="float: right"}La contienda por la 
